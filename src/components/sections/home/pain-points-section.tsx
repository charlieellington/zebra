          ...
          >
            <AccordionItem value="pain1">
              <AccordionTrigger className="text-left text-sm md:text-base font-medium hover:no-underline">
                &ldquo;12-month nightmare dev timelines&rdquo;
              </AccordionTrigger>
            ...
            <AccordionItem value="pain2">
              <AccordionTrigger className="text-left text-sm md:text-base font-medium hover:no-underline">
                &ldquo;Design vs dev mismatch&rdquo;
              </AccordionTrigger>
              <AccordionContent className="text-sm md:text-base text-muted-foreground">
            ...
            <AccordionItem value="pain3">
              <AccordionTrigger className="text-left text-sm md:text-base font-medium hover:no-underline">
                &ldquo;Freelancers without priorities&rdquo;
              </AccordionTrigger>
              <AccordionContent className="text-sm md:text-base text-muted-foreground">
            ...
            <AccordionItem value="pain4">
              <AccordionTrigger className="text-left text-sm md:text-base font-medium hover:no-underline">
                &ldquo;Burning cash without users or validation&rdquo;
              </AccordionTrigger>
              <AccordionContent className="text-sm md:text-base text-muted-foreground">
                <strong className="text-foreground">
