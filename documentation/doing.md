0. Check Cursor pricing so you're ready to code at low cost 
...
1. Start with step1-steup in cursor 
- Check if it needs anything to be 100% confident 
- Start implementing 
...
3. Do steps 3 and 4 onwards in o3 research, see the prompts below 
- Make sure you attached the key visuals guide and the overall build plan
- Whilst executing previous steps... 

4. Until you've done the full website. 
...
Do the build plan for this section, thinking about best practices. 
...
- Consider that pricing is just an intro and will link to a more detailed pricing page on the button in it - [Pricing Calculations] . 
